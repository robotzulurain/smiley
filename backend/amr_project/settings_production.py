"""
Production settings for AMR Surveillance Application
"""
import os
...
# CORS settings
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'https://amrfrontend.netlify.app,http://localhost:5173').split(',')
